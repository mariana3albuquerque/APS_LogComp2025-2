...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_LIGAR = 3,                      /* LIGAR  */
  YYSYMBOL_DESLIGAR = 4,                   /* DESLIGAR  */
  YYSYMBOL_SETAR = 5,                      /* SETAR  */
  YYSYMBOL_AUMENTAR = 6,                   /* AUMENTAR  */
  YYSYMBOL_DIMINUIR = 7,                   /* DIMINUIR  */
  YYSYMBOL_SLEEP_KW = 8,                   /* SLEEP_KW  */
  YYSYMBOL_SE = 9,                         /* SE  */
...
#line 207 "tvlang.y"
    {
        ...
        char *tmp = concat(buf, (yyvsp[0].str));
        (yyval.str) = tmp;
        free((yyvsp[0].str));
    }
...
#line 221 "tvlang.y"
    {
        ...
        free(tmp1);
        char *tmp = concat(tmp2, (yyvsp[-1].str));
        free(tmp2);
        char *res = concat(tmp, ";");
        free(tmp);
        (yyval.str) = res;
